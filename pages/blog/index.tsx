    ...
    return (
        <>
            <Head>
                ...
                <meta name="keywords" content='InnoAds'/>
            ...
            <MainLayout>
                ...
                <main>
                    ...
                    <p>Наступает момент, когда надо продать вещь. Причины разные: некогда любимый вид спорта перестал
                        вас
                        радовать и надо продать велосипед или гантели, купили новый телефон, переезд. Как выгодно
                        продать?
                    </p>Для начала, постарайтесь сделать хорошое фото вашего товара. Найдите все аксесуары, чеки и
                    упаковку.
                    ...
                    <p>Если вам позвонили по объявлению, то не соглашайтесь на просьбу скидки по телефону! Такое часто
                        ...
                        и
                        не
                        предъявив объективные причины для скидки, ее просят. Если вы согласитесь сразу, то наверняка у
                        них
                        будет
                        соблазн еще скинуть цену при встрече. Если вы уверены в цене, то вы - хозяин ситуации и не
                        соглашайтесь
                        на
                        уступки. Процесс прощания с товаром должен быть приятным и вам, и покупателю.
                    </p>
